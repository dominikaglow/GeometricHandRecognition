...
def compare_features(features1, features2):
    """
    Compare the HOG and Color Histogram features of two images and return their combined distance.
    """
    ...
    return 0.5 * chi_hog + 0.5 * chi_color_histogram
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("Usage: python compare_new.py <features_json>")
        sys.exit(1)
